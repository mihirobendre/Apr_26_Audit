...
<qgis styleCategories="AllStyleCategories" maxScale="0" symbologyReferenceScale="-1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" autoRefreshTime="0" autoRefreshMode="Disabled" labelsEnabled="0" simplifyAlgorithm="0" minScale="100000000" simplifyDrawingTol="1" version="3.40.5-Bratislava" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0">
  <flags>
  ...
  <temporal mode="2" durationUnit="min" endField="" startField="" endExpression="" startExpression="" enabled="0" durationField="tessellate" fixedDuration="0" limitMode="0" accumulate="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation extrusionEnabled="0" clamping="Relative" binding="Centroid" extrusion="0" type="IndividualFeatures" symbology="Line" showMarkerSymbolInSurfacePlots="0" zoffset="0" respectLayerSymbol="1" zscale="1">
    ...
    <profileLineSymbol>
      <symbol type="line" name="" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" class="SimpleLine" id="{1e255c37-96d1-4ca6-aa0a-2a0f7403c2fd}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" name="" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" locked="0" enabled="1" class="SimpleFill" id="{e9800b8c-cd56-4923-aeac-0e3b34000b7f}">
          <Option type="Map">
            ...
            <Option type="QString" name="offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="offset_unit" value="MM"/>
            <Option type="QString" name="outline_color" value="104,59,32,255,rgb:0.40614938582436866,0.22967879758907453,0.12603952086671244,1"/>
    ...
    <profileMarkerSymbol>
      <symbol type="marker" name="" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" locked="0" enabled="1" class="SimpleMarker" id="{8866a2ba-8e6d-424f-941a-7e60a90e0f73}">
          <Option type="Map">
  ...
  <renderer-v2 referencescale="-1" enableorderby="0" type="singleSymbol" forceraster="0" symbollevels="0">
    <symbols>
      <symbol type="fill" name="0" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
        ...
        <layer pass="0" locked="0" enabled="1" class="SimpleLine" id="{e48c9387-7ea8-40b3-89aa-a3f178590a53}">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="5;2"/>
            ...
            <Option type="QString" name="draw_inside_polygon" value="0"/>
            <Option type="QString" name="joinstyle" value="bevel"/>
            <Option type="QString" name="line_color" value="174,27,216,255,hsv:0.79649999999999999,0.87516594186312657,0.8477149614709697,1"/>
            <Option type="QString" name="line_style" value="solid"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="fill" name="" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" frame_rate="10">
        ...
        <layer pass="0" locked="0" enabled="1" class="SimpleFill" id="{e62ba096-f138-4091-8dce-a217c19340ed}">
          <Option type="Map">
            <Option type="QString" name="border_width_map_unit_scale" value="3x:0,0,0,0,0,0"/>
  ...
  <splitPolicies>
    ...
    <policy field="timestamp" policy="Duplicate"/>
    <policy field="begin" policy="Duplicate"/>
    <policy field="end" policy="Duplicate"/>
    <policy field="altitudeMode" policy="Duplicate"/>
    <policy field="tessellate" policy="Duplicate"/>
    <policy field="extrude" policy="Duplicate"/>
    <policy field="visibility" policy="Duplicate"/>
    <policy field="drawOrder" policy="Duplicate"/>
    <policy field="icon" policy="Duplicate"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy field="Name" policy="Duplicate"/>
    <policy field="description" policy="Duplicate"/>
  ...
  <constraints>
    ...
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="timestamp"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="begin"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="end"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="altitudeMode"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="tessellate"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="extrude"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="visibility"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="drawOrder"/>
    <constraint constraints="0" exp_strength="0" notnull_strength="0" unique_strength="0" field="icon"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" name="timestamp" hidden="0" width="-1"/>
      <column type="field" name="begin" hidden="0" width="-1"/>
      <column type="field" name="end" hidden="0" width="-1"/>
      <column type="field" name="altitudeMode" hidden="0" width="-1"/>
      <column type="field" name="tessellate" hidden="0" width="-1"/>
      <column type="field" name="extrude" hidden="0" width="-1"/>
      <column type="field" name="visibility" hidden="0" width="-1"/>
      <column type="field" name="drawOrder" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="altitudeMode"/>
    <field reuseLastValue="0" name="begin"/>
    <field reuseLastValue="0" name="description"/>
    <field reuseLastValue="0" name="drawOrder"/>
    <field reuseLastValue="0" name="end"/>
    <field reuseLastValue="0" name="extrude"/>
    <field reuseLastValue="0" name="icon"/>
    <field reuseLastValue="0" name="tessellate"/>
